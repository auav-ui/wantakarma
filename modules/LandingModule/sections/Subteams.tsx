  ...
  return (
    <section className="overflow-x-clip">
      ...
      <div className="flex justify-center relative">
        <div className="grid max-md:grid-rows-3 md:grid-cols-3 gap-8 xl:gap-24 py-6 md:py-16 xl:py-40 z-10">
        ...
        <img
          ...
          alt="flag"
          className="absolute max-md:min-w-[40rem] md:w-2/3 right-0 top-0 md:translate-x-1/4 translate-y-1/3 md:-translate-y-1/3"
        />
        <img
          src="/misc/race-flag.webp"
          alt="flag"
          className="absolute max-md:min-w-[40rem] md:w-2/3 left-0 bottom-0 -translate-y-1/3 md:-translate-x-1/4 md:translate-y-1/3 rotate-180"
        />
      </div>
    </section>
  );
